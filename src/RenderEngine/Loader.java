...
public class Loader
{
    ...
    public void addInstancedAttribute(int vao, int vbo, int attribute, int dataSize, int dataLength, int offset)
    {
        ...
        GL20.glVertexAttribPointer(attribute, dataSize, GL11.GL_FLOAT, false, dataLength * 4, offset * 4L);
    ...
    public RawModel loadToVAO(float[] positions, int dimensions, float[] textures)
    {
        int vaoID = createVAO();
        this.storeDataInAttributeList(0, dimensions, positions);
    ...
    public int loadTexture(String fileName)
    {
        ...
        try
        {
            ...
            InputStream is = classloader.getResourceAsStream("res/" + fileName + ".png");
    ...
    private TextureData decodeTextureFile(String fileName) {
        ...
        try {
            ClassLoader classloader = Thread.currentThread().getContextClassLoader();
            InputStream in = classloader.getResourceAsStream("res/" + fileName + ".png");;
